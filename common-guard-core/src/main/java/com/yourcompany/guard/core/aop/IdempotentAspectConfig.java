...
public final class IdempotentAspectConfig {
    ...
    public IdempotentAspectConfig(String keyPrefix, boolean failOnError, boolean logEnabled, boolean logRawKey, int logKeyMaxLength) {
